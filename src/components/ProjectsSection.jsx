...
const projects = [
  {
    ...
    description:
      "A beautiful landing page app using NextJS and TailwindCSS, SEO.",
  ...
  },
  {
    id: 2,
    title: "Web Cây cảnh",
    description: "Covert html,css,js to ReactJS TailwindCSS",
  ...
  },
  {
    id: 3,
    title: "Blog",
    description: "First project with NextJS, SSR, CSR",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, key) => (
            ...
            >
              <a href={project.demoUrl} target="_blank" className="cursor">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/Thanh410/"
          >
